          ...
          <div class="mb-6">
            ...
            <div class="space-y-6">
              ...
              <div class="p-4 shadow-sm text-center">
                ...
                <p class="text-gray-600 text-sm mt-2">{!! Str::words($syaikhuna->deskripsi ?? 'Deskripsi tidak tersedia', 70, '...') !!}</p>
                <a href="{{ route('syaikhuna') }}" class="text-green-500 text-sm font-medium hover:underline">
                    Baca Selengkapnya
                </a>
              </div>
              @endif
