 ...
 <header class="bg-white shadow sticky top-0 z-50" x-data="{ isOpen: false }">
  <div class="mx-auto max-w-8xl px-4 py-4 sm:px-6 lg:px-4">
      <div class="flex h-16 items-center justify-between">
          <!-- Logo -->
          <div class="flex items-center">
              <div class="flex-shrink-0 md:ml-16">
                  <img id="logo" class="h-auto w-auto max-w-[150px]" src="{{ asset('assets/img/logo-PPDR.png') }}" alt="logo">
              </div>
          </div>

          <!-- Script perubahan logo saat scroll -->
          <script>
              window.addEventListener('scroll', function() {
                  var logo = document.getElementById('logo');
