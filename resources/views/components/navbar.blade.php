        ...
        <div class="flex items-center">
          <ul class="flex">
            ...
            <li class="flex items-center text-white text-m">
              <a href="#" class="text-white text-sm hover:text-green-900"><i class="fa-solid fa-map-location-dot mr-2"></i>Kedung, Buaran, Kec.Mayong, Kabupaten Jepara, Jawa Tengah 59465, Indonesia</a></li>
          </ul>
        </div>
        <div class="flex items-center">
