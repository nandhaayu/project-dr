  ...
  <div class="card">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4">Profil</h5>
        @if(!$profil) <!-- Jika profil tidak ada, tampilkan tombol -->
        ...
        <table class="table table-bordered mt-4">
          ...
          <tbody>
            ...
            <tr>
              <td>{{ $profil->judul }}</td>
              <td><img src="{{ asset('assets/images/' . $profil->foto) }}" alt="project-image" class="rounded" style="width: 100%; max-width: 100px; height: auto;"></td>
