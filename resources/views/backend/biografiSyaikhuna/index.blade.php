...
<div class="container-fluid">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4">Biografi Syaikhuna</h5>
        @if(!$syaikhuna) <!-- Jika syaikhuna tidak ada, tampilkan tombol -->
          <a href="{{ route('biografi.syaikhuna.create') }}" class="bg-green-600 mb-2 px-2 py-2 rounded-lg text-white hover:bg-green-700">+ Tambah Data</a>
        @endif
        ...
        <table class="table table-bordered mt-4">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                  <a href="{{ route('biografi.syaikhuna.edit', $syaikhuna->id) }}" class="btn btn-warning btn-sm">Edit</a>
                  ...
                  @include('backend.biografiSyaikhuna.delete')
              </td>
          </tr>
            @else
                <tr>
